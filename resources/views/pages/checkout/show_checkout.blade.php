    ...
    <section id="cart_items">
        <div class="container">
            <div class="breadcrumbs">
                <ol class="breadcrumb">
                    <li><a href="{{URL::to('/')}}">Trang chủ</a></li>Giảng viên: Ngô Lê Quân 8
                        ...
                        <div class="bill-to">
                            ...
                            <div class="form-one">
                                <form
                                    ...
                                    <input type="text"
                                           name="shipping_name" placeholder="Họ và tên">Giảng viên: Ngô Lê Quân 9
                                    <input type="text"
...
Paypal</label>
</span>Giảng viên: Ngô Lê Quân 11
            </div>
        </div>
    </section> <!--/#cart_items-->
@endsection